      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-32 pb-16 md:pt-52 md:pb-32">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="h1 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4" data-aos="fade-down">Never Miss A Call Again </h1>
            ...
            <p className="text-lg text-slate-300 mb-8" data-aos="fade-down" data-aos-delay="200">
              Build and deploy an AI voice assistant to answer your clients 24/7 without code.</p>
