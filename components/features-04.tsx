        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20">
          ...
          <div className="divide-y divide-slate-800">
            ...
            <div className="py-8 first-of-type:pt-0 last-of-type:pb-0">
              <div>
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-6">Customer Interaction</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Always Available</h4>
                  </div>
                  <p className="text-sm text-slate-400"> Nelovoice operates 24/7, ensuring your business is always accessible to customers.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Personalized Engagement</h4>
                  </div>
                  <p className="text-sm text-slate-400">Customize your AI to interact with clients according to your specific needs and preferences.</p>
                </div>
              </div>
            </div>
            {/* Row */}
            <div className="py-8">
              <div>
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-6">Operational Efficiency</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Efficient Lead Screening</h4>
                  </div>
                  <p className="text-sm text-slate-400">Automatically qualify leads, saving time and boosting your sales pipeline.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Automated Follow-Ups</h4>
                  </div>
                  <p className="text-sm text-slate-400">Handle customer follow-ups with automated efficiency.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Seamless Logistics</h4>
                  </div>
                  <p className="text-sm text-slate-400">Manage tracking and provide real-time updates effortlessly.</p>
                </div>
              </div>
            </div>
            {/* Row */}
            <div className="py-8">
              <div>
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-6">Robust Infrastructure and Insights</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Scalable Solution</h4>
                  </div>
                  <p className="text-sm text-slate-400">Easily thousands of concurrent calls with our scalable infrastructure.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">High Reliability</h4>
                  </div>
                  <p className="text-sm text-slate-400">Ensure consistent performance with our robust, secure, and reliable system.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Insightful Analytics</h4>
                  </div>
                  <p className="text-sm text-slate-400">Gain valuable business insights with detailed analytics on customer interactions.</p>
                </div>
              </div>
            </div>
          </div>
