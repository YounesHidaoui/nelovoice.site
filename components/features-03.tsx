      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-16 pb-12 md:pt-32 md:pb-20 border-b border-slate-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4  "> AI Call Center For Your Business</h2>
            <p className="text-lg text-slate-400 ">Built-in features to make your voicebot as natural, responsive, and reliable as a real person.</p>
          </div>
