      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-16 md:pt-32">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">Human-Like Voice Agent</h2>
            <p className="text-lg text-slate-400">NeloVoice's AI-powered voices are remarkably lifelike, capturing the nuances of human speech</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Turbo Latency</h4>
              </div>
              <p className="text-sm text-slate-400"> Fast and smooth conversations with intelligent caching and low-latency audio streaming</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Interruption Management</h4>
              </div>
              <p className="text-sm text-slate-400">Our AI knows when to pause, ensuring smooth and natural interactions without talking over clients.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Scalability</h4>
              </div>
              <p className="text-sm text-slate-400"> Handle over 10k calls at once with our highly scalable and reliable infrastructure.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">No code integration</h4>
              </div>
              <p className="text-sm text-slate-400">Empower your voicebot to book appointments, look up data, fill forms, and more with ease.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Multilingual Support</h4>
              </div>
              <p className="text-sm text-slate-400">Communicate in over 100 languages, including English, French, German, Arabic, and Portuguese.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Private communication</h4>
              </div>
              <p className="text-sm text-slate-400">Ensure reliable connections around the world with our dedicated private internet infrastructure.
</p>
            </div>
          </div>
